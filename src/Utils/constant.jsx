...
` },
  { id: 20099, chapterId: 20115, title: "Operating System Concepts" , content: `
    ...
    **Answer:**
    ...
    >- __Drawback:__It’s hard to know the burst time in advance, and it can cause "starvation," where longer processes never get a chance to run.
    >
    >**3. Round Robin (RR):**
    ...
    >- __Drawback:__If the time slice is too long, it can become similar to FCFS; if it’s too short, the system might waste time switching between processes.
    >
    >**4. Round Robin (RR):**
    >- In Round Robin, each process gets a small amount of time to use the CPU (called a time slice or quantum). After each slice, the process is put at the end of the line, and the next process gets a turn. It’s like everyone gets a chance in a circle.
    >- __Drawback:__If the time slice is too long, it can become similar to FCFS; if it’s too short, the system might waste time switching between processes.
    ...
    **Answer:**
    >__Thread:__A thread is the smallest unit of execution within a process. A process can have multiple threads running at the same time, sharing the same memory and resources.
    >
    >__Process:__A process is a program that is currently running. It has its own memory space, resources (like CPU and I/O), and execution environment.
