        ...
        <div className="">
            ...
            <div className="bg-gray-100 w-full">
                <div className="flex flex-col md:flex-row justify-around items-start py-8 md:px-44 px-4 font-sans">
                    ...
                    <div className="item-start md:w-1/2  md:text-left mb-8 md:mb-0">
            ...
            {/* Module Section */}
            <div className="my-4 md:my-10 mx-auto text-center max-w-4xl">
                <h1 className="font-bold text-lg md:text-2xl mb-4 md:mb-8">
                ...
                <div className="flex justify-center gap-x-11 items-center text-center mx-auto">
                    <div className="flex flex-col items-center mb-10">
                        <img
                            ...
                            className="w-16 h-16 md:w-24 md:h-24 rounded-full object-cover shadow-md mb-1 md:mb-4"
                        />
                        <h3 className="font-semibold text-md md:text-lg text-gray-900">Mithalesh</h3>
                    ...
                    <div className="flex flex-col items-center mb-10">
                        <img
                            ...
                            className="w-16 h-16 md:w-24 md:h-24 rounded-full object-cover shadow-md mb-1 md:mb-4"
                        />
                        <h3 className="font-semibold text-md md:text-lg text-gray-900">Kundan</h3>
                ...
                <div className="my-4 md:my-10 mx-2 md:mx-auto text-center max-w-4xl">
                    {modules.map((module) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <div
                                    key={module.id}
                                    className="border  border-gray-300  rounded-lg my-4 md:w-11/12 mx-4 md:mx-auto bg-white"
                                >
                                    <div className="">
                                        {moduleChapters.map((ch, index) => (
                                            <div key={ch.id} className="">
                                                {/* Chapter Header */}
                                                <div
                                                    className={`flex items-center justify-between cursor-pointer ${expandedId === ch.id &&
                                                        `bg-gradient ${index === 0 && `rounded-t-lg`
                                                        }  text-white`
                                                        }  p-4 transition`}
                                                ...
                                                <div
                                                    className={`transition-all duration-300 ease-in-out overflow-hidden  ${expandedId === ch.id
