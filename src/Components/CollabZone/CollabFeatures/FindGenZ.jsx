  ...
  return (
    <section className="flex flex-col justify-center items-center h-auto mt-6 mx-4 md:mx-8 bg-white rounded-lg p-8 shadow-lg">
      ...
      <p className="text-lg text-gray-700 mb-6 max-w-lg text-center">
        ...
        <span className="text-blue-500 font-bold">Find GenZ</span> is your go-to
        hub for discovering ambitious young talents who are shaping the future
        of tech, business, and innovation.
      </p>
      <p className="text-lg text-gray-700 mb-6 max-w-lg text-center">
        Whether you're searching for a visionary co-founder, a tech-savvy CTO,
        or simply a partner for your next project,{" "}
        <span className="text-green-500 font-bold">Find GenZ</span> connects you
        with trailblazers eager to build, create, and transform industries.
      </p>
      <p className="text-lg text-gray-700 mb-6 max-w-lg text-center">
        Be part of the movement. Discover the energy, passion, and fresh
        perspectives that Gen Z brings to the table, and start creating
